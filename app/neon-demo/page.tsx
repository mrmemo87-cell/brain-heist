...
export default function NeonDemoPage() {
  return (
    <main className="min-h-[80vh] max-w-6xl mx-auto px-6 py-10">
      <h1 className="text-3xl font-extrabold tracking-tight">Neon Card вЂ” Accent Gallery</h1>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
        ...
        <NeonCard accent="pink"    title="Magenta Pop"   subtitle="accent: pink">Bold & flashy.</NeonCard>
      </div>
    </main>
  );
}
